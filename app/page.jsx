          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="mx-auto lg:mr-0 flex items-center justify-center">
              <div className="relative">
                <div className="absolute -left-4 -top-4 h-72 w-72 bg-accent/30 rounded-full blur-3xl" />
                <div className="absolute -right-4 -bottom-4 h-72 w-72 bg-secondary/30 rounded-full blur-3xl" />
                <img
                  alt="Hero"
                  className="relative mx-auto aspect-square overflow-hidden rounded-full object-cover object-center"
                  height="400"
                  src="/hero-image.jpg"
                  width="400"
                />
      ...
      <section id="testimonios" className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3 lg:gap-12">
            <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-lg">
              <div className="space-y-2">
              ...
              <div className="flex items-center space-x-4">
                <div className="rounded-full bg-secondary/10 p-2">
                  <PawIcon className="h-6 w-6 text-secondary" />
                </div>
                <div>
