...
export default function ServiceDetailPage({ params }) {
  ...
  const service = {
    ...
    image: serviceImages[Number.parseInt(params.id)] || "/vet-service.jpg",
    description:
            ...
            <div>
              <Card className="sticky top-20">
                ...
                <CardFooter className="flex flex-col space-y-4">
                  ...
                  <Button className="w-full" onClick={handleReserve} disabled={!selectedDate || !selectedTime || !pet || loading}>
                  ...
                  {success === true && (
                    <div className="bg-green-100 border border-green-300 rounded-lg p-6 text-center animate-fade-in mt-4">
                      ...
                      <Button onClick={() => window.location.href = '/history'} className="mt-2">Ver historial de reservas</Button>
                    </div>
                  )}
                  {success === false && (
...
export async function generateStaticParams() {
  // Solo los ids de servicios simulados
  return [
    { id: "1" },
    { id: "2" },
    { id: "3" },
